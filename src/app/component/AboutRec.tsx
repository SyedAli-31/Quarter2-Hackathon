    ...
    <div className="grid md:grid-cols-2  ">
      ...
      <div className="mt-[60px] md:h-[450px] flex items-center">
        <Image
          ...
          width={700}
          height={450}
          className="md:w-[710px] w-[340px] h-full object-cover"
        />
      </div>
      {/* Text Box */}
      <div className=" bg-[#F9F9F9] w-[340px] md:w-[720px] md:h-[450px] shadow-lg p-8 flex flex-col   mt-[60px] ">
        ...
        <button className="w-[170px] bg-[#F9F9F926] text-[#2A254B] px-6 py-3 rounded shadow hover:bg-gray-200 mt-[80px] md:ml-[92px]">
          Get In Touch
        </button>
      </div>
      </div>
